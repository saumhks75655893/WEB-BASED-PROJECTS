...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <!-- for filter result -->
        <div class="col-lg-3 col-md-12  px-4" style="font-size: 14px;">
            ...
            //                  
            //                     <a href="room_details.php?id=$room_data[id]" class="btn btn-sm p-2 btn-outline-dark  fw-bold w-100">More details</a>
            //                 </div>
            //             </div>
            //         </div>
            //    data;
